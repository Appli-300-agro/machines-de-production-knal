# Machines de production knal - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Machines de production knal**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@machinesdeproductionknal.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@machinesdeproductionknal.cm` | `user123` | |
...
*   **Contact :** contact@machinesdeproductionknal.cm